...
/* harmony import */ var _components_form_validation__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_form_validation__WEBPACK_IMPORTED_MODULE_2__);
...
$(function () {
  ...
  $('.copy-to-clipboard').on('click', function (e) {
    e.preventDefault(); // Copy to clickboard
    ...
    document.body.removeChild(sampleTextarea); // Update Tooltip

    $(this).attr('data-bs-original-title', 'Скопійовано'); // Fire new tooltip

    var btn_tooltip = bootstrap.Tooltip.getInstance($(this));
    btn_tooltip.show(); // Return old one
  ...
  $('.btn-copy').on('click', function (e) {
    ...
    document.execCommand("copy");
    document.body.removeChild(sampleTextarea); // New btn Status
...
/***/ "./resources/js/components/form-input-coordinates.js":
/*!***********************************************************!*\
  !*** ./resources/js/components/form-input-coordinates.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "CreateCoor": () => (/* binding */ CreateCoor),
/* harmony export */   "DeleteCoor": () => (/* binding */ DeleteCoor)
/* harmony export */ });
// to do list 
var coors = [];
var currentCoor = {
...
function DrawCoor(coor) {
  var newCoorHTML = "\n    <div class=\"pb-3 coor-item\" coor-id=\"".concat(coor.id, "\">\n        <div class=\"input-group\">\n            <input type=\"text\" readonly class=\"form-control\" name=\"coordinates[").concat(coor.id, "][long][]\" value=\"").concat(coor["long"], "\">\n            <input type=\"text\" readonly class=\"form-control\" name=\"coordinates[").concat(coor.id, "][lang][]\" value=\"").concat(coor.lang, "\">\n            <input type=\"text\" readonly class=\"form-control\" name=\"coordinates[").concat(coor.id, "][desk][]\" value=\"").concat(coor.desk, "\">\n            \n            <button coor-id=\"").concat(coor.id, "\" class=\"btn btn-outline-secondary bg-danger text-white\" type=\"button\" onclick=\"DeleteCoor(this);\" id=\"button-addon2 \">X</button>\n            \n        </div>\n    </div>\n      ");
...
function DeleteCoor(button) {
  ...
  var $old_item = $(".coor-item[coor-id=".concat(deleteID, "]"));
...
/***/ "./resources/js/components/form-select2.js":
/*!*************************************************!*\
  !*** ./resources/js/components/form-select2.js ***!
  \*************************************************/
/***/ (() => {

     ...
     <div class="col-xl-6 mx-auto">
       <div class="card radius-10">
         <div class="card-body p-5">
              {{ Form::open(['route' => ['users.update', $user->id], 'method' => 'PATCH', 'enctype' => 'multipart/form-data', 'class' => 'row g-3 needs-validation', 'novalidate' => true, 'oninput' => '\'confirmPassword.setCustomValidity(confirmPassword.value != password.value ? true : false)\'']) }}
                ...
                <div class="col-md-12">
                  ...
                  {{ Form::select('role', ['' => '','agent' => 'Агент', 'officer' => 'Офісер'], $user->role, ['class' => 'single-select', 'required' => true]) }}

         ...
         <div class="card-body p-5">
              {{ Form::open(['route' => 'users.store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'class' => 'row g-3 needs-validation', 'novalidate' => true, 'oninput' => '\'confirmPassword.setCustomValidity(confirmPassword.value != password.value ? true : false)\'']) }}
                ...
                <div class="col-md-12">
                  ...
                  {{ Form::text('name', null, ['class' => 'form-control', 'id' => 'user-name', 'placeholder' => 'Горинич', 'required' => true]) }}
                ...
                <div class="col-md-12">
                    ...
                    {{ Form::text('email', null, ['class' => 'form-control', 'id' => 'user-email', 'placeholder' => 'example@gmail.com', 'required' => true]) }}
